"""
Django settings for linuxwalls project.
...
SECRET_KEY = 's04+msoj+p*-mpestyji0nrw%24-#cee0x%8cpe8-yemfxjaay'
...
WSGI_APPLICATION = 'linuxwalls.wsgi.application'
